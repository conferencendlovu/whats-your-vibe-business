...
//        View convertView = layoutInflater.inflate(R.layout.place_auto_complete_result, viewGroup, false);
...
//            super(itemView);
//            area = itemView.findViewById(R.id.place_auto_complete_tvArea;
//            address = itemView.findViewById(R.id.place_auto_complete_tvAddress);
//            mRow = itemView.findViewById(R.id.place_auto_complete_tvRow);
